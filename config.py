...
QWEN_SCENE_PROMPT_PROMPT = """You convert Hindi/Hinglish/English story text into English image
...
QWEN_EMOTION_CLASSIFY_PROMPT = """You analyze Hindi/Hinglish/English text for vocal emotion.
